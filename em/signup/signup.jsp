	...
	<%
		...
		try{
			...
			if(i == 1){
				...
				String sql = "create table "+username+"(id int not null auto_increment primary key,uname varchar(50) not null,status varchar(20) not null, pkey varchar(500) not null, r_pkey varchar(500), flag varchar(5))";
